...
<main>
        <div class="profile-container">
         <div class="profile-card">
                <div class="profile-photo">
                    <img src="photos/default-profile.png" alt="Фото профиля" id="profile-img" onclick="openAvatarDialog()">
                </div>
                ...
                <?php
                    ...
                    echo "<button id='deleteCookiesBtn' class='cta-button' style='transition: all ease 0.8s'>Выход из профиля</button>";
                ?>
                </div>

        </div>
        <div class="buttons-container connect">
        ...
        <form action="<?= $url ?>">
            <button class="connect-btn google">
                ...
                <button class="disconnect-btn google"><i class="fas fa-times"></i></button>
        ...
        <button class="connect-btn apple">
        <i class="fab fa-apple"></i> Подключить Apple
        <button class="disconnect-btn apple"><i class="fas fa-times"></i></button>
        </button>
        </div>

    <div class="account-btn-wrapper">
    <!-- Кнопка Facebook с иконкой -->
    <button class="connect-btn facebook">
      <i class="fab fa-facebook"></i> Подключить Facebook
      <button class="disconnect-btn facebook"><i class="fas fa-times"></i></button>
    </button>
    </div>
...
document.getElementById("deleteCookiesBtn").addEventListener("click", function() {
    ...
    window.location.replace("https://entify.com"); // Замените на нужный URL
